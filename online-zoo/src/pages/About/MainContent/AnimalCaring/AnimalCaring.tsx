  ...
  return (
    <div className="animal-caring">
      ...
      <div className="feed-animal-container">
        ...
        <section>
          <div>
            <img src="./images/animal-care/panda.png" alt="panda is eating" />
          </div>
          <div>
            <p>
        ...
        <section className="tiger-section">
          <div>
            <img src="./images/animal-care/tiger.png" alt="Tigers" />
          </div>
          <div>
            <p>
              Your $150 will help to care for Senja, a Sumatran tiger, for three
              weeks.
            </p>
            <button>
              feed
        ...
        <section>
          <div>
            <img src="./images/animal-care/lemur.png" alt="lemur" />
          </div>
          <div>
            <p>
              With your support, we can give Andy his favorite fruits.
              Especially when it's not fruit season in its natural habitat.
            </p>
            <button>
              feed
              <svg
        ...
        <section>
          <div>
            <img
              src="./images/carousel-images/two-eagles.png "
              alt="two eagles"
            />
          </div>
          <div>
